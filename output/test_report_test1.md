...
- 测试时间：2026-09-19 11:13:11
- 结果：42/42 项通过

| 功能 | 结果 | 说明 |
|---|---|---|
| test1 登录 | 通过 | {"user":{"id":1,"username":"test1"}}
 |
| 创建测试学科 | 通过 |  |
| 知识点树父子层级 | 通过 |  |
| 错题录入 | 通过 |  |
...
| 30 天趋势接口 | 通过 |  |
| 复习优先级接口 | 通过 |  |
| 创建复习计划 | 通过 | {'overdue': 4, 'today': 1, 'total': 5} |
| 完成复习计划 | 通过 |  |
| 知识库内容新增 | 通过 |  |
| 知识库内容修改 | 通过 |  |
| 学习资源新增 | 通过 |  |
...
| AI 变式练习 | 通过 | {"mode":"variant","questions":[{"analysis":"\u6839\u636e\u5bfc\u6570\u7684\u8fd0\u7b97\u6cd5\u5219\uff0c\u5bf9\u591a\u98 |
| AI 知识点精要 | 通过 | {"content":"\u81ea\u52a8\u5316\u5bfc\u6570\u77e5\u8bc6\u5361\u7247\n\n\u4e00\u3001\u6838\u5fc3\u6982\u5ff5\n\u81ea\u52a8 |
| AI 学习资源推荐 | 通过 | {"mode":"resources","resources":[{"content":"\u9002\u5408\u5728\u5b66\u5b8c\u94fe\u5f0f\u6cd5\u5219\u548c\u8ba1\u7b97\u5 |
| AI 单题解答 | 通过 | {"content":"1. \u8fd9\u9053\u9898\u8003\u67e5\u7684\u77e5\u8bc6\u70b9\n\u672c\u9898\u8003\u67e5\u7684\u662f\u57fa\u672c\ |
| OCR 图片识别 | 通过 | {"text":"\u5df2\u77e5\u51fd\u6570f(x)=2x+1\uff0c\u6c42\u5bfc","url":"/uploads/ocr_a427f9c1.png"}
 |
...
| 彻底删除 | 通过 |  |
| 导出单一数据包 | 通过 |  |
| 导入数据包 | 通过 | {"ok":true,"stats":{"knowledge_points":23,"questions":9,"subjects":8}}
 |
